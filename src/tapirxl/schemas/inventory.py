...
_ProductLiteral = Literal[  # type: ignore[valid-type]
    "windows_7", "windows_10", "windows_server",
    "intellivue_mx700", "brilliance_ict",
    "clinical_collaboration_platform", "pan_os",
]
_DeviceClassLiteral = Literal[  # type: ignore[valid-type]
    "CT", "MR", "US", "CR", "DX", "MG", "NM", "PT",
    "patient_monitor", "clinical_workstation", "workstation",
    "server", "pacs", "firewall", "dhcp_server",
]
